...
} }); }); }, t.prototype.updateMatrix = function () { return tslib_1.__awaiter(this, void 0, void 0, function () { var t = this; return tslib_1.__generator(this, function (e) { return this.matrix.forEach(function (e, i) { e.forEach(function (e, r) { var s = t.elements[i][r]; s && (s.classList.toggle(t.onClass, e), s.classList.toggle(t.offClass, !e)); }); }), [2]; }); }); }, Object.defineProperty(t, "is", { get: function () { return "microbit-matrix"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(t, "properties", { get: function () { return { el: { elementRef: !0 }, idTemplate: { type: String, attr: "id-template" }, offClass: { type: String, attr: "off-class" }, onClass: { type: String, attr: "on-class" }, services: { type: "Any", attr: "services", watchCallbacks: ["watchHandler"] } }; }, enumerable: !0, configurable: !0 }), t; }();
