...
} }); }); }, e.prototype.render = function () { return microbit_core_js_1.h("div", null, this.temperature); }, Object.defineProperty(e, "is", { get: function () { return "microbit-temperature"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "properties", { get: function () { return { disconnectedText: { type: String, attr: "disconnected-text" }, el: { elementRef: !0 }, noTemperature: { type: String, attr: "no-temperature" }, services: { type: "Any", attr: "services", watchCallbacks: ["watchHandler"] }, temperature: { state: !0 }, temperaturePeriod: { type: Number, attr: "temperature-period" } }; }, enumerable: !0, configurable: !0 }), e; }();
exports.MicrobitTemperature = MicrobitTemperature;
chunk_d2120d7f_js_1.a.injectProps(MicrobitTemperature, ["services"]);
