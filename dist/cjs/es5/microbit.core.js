...
} var l = e.namespace || "microbit"; return x || (x = !0, function v(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var e = this && this.v || function (n, t, e, r) { return new (e || (e = Promise))(function (i, o) { function u(n) { try {
    ...
    throw e[1]; return { value: e[0] ? e[1] : void 0, done: !0 }; }([e, u]); }; } var r, i, o, u, f = { label: 0, g: function () { if (1 & o[0])
        throw o[1]; return o[1]; }, M: [], m: [] }; return u = { next: e(0), throw: e(1), return: e(2) }, "function" == typeof Symbol && (u[Symbol.iterator] = function () { return this; }), u; }, i = this, o = function () { };
function applyPolyfills(n) { n.j = function () { function t() { var n = setTimeout; return function () { return n(e, 1); }; } function e() { for (var n = 0; n < b; n += 2)
    ...
    return P.error = n, P;
} } function f(n, t, e) { t.constructor === n.constructor && e === r && t.constructor.resolve === i ? function (n, t) { t.k === W ? s(n, t.A) : t.k === x ? l(n, t.A) : v(t, void 0, function (t) { return c(n, t); }, function (t) { return l(n, t); }); }(n, t) : e === P ? (l(n, P.error), P.error = null) : void 0 === e ? s(n, t) : "function" == typeof e ? function (n, t, e) { g(function (n) { var r = !1, i = function (n, t, e, r) { try {
    n.call(t, e, r);
}
catch (n) {
    return n;
...
} } function a(n) { n.S && n.S(n.A), p(n); } function s(n, t) { n.k === T && (n.A = t, n.k = W, 0 !== n.O.length && g(p, n)); } function l(n, t) { n.k === T && (n.k = x, n.A = t, g(a, n)); } function v(n, t, e, r) { var i = n.O, o = i.length; n.S = null, i[o] = t, i[o + W] = e, i[o + x] = r, 0 === o && n.k && g(p, n); } function p(n) { var t = n.O, e = n.k; if (0 !== t.length) {
...
var u = {}, f = function (n) { return null != n; }, c = function (n) { return n.toLowerCase(); }, a = function (n) { return c(n).split("-").map(function (n) { return n.charAt(0).toUpperCase() + n.slice(1); }).join(""); }, s = "http://www.w3.org/1999/xlink", l = function (n, t, e, r, i, o) { if ("class" !== e || o)
    ...
    case 12: return [2];
} }); }); }, A = function (n, t, e, r, i, o, u) { (u = n.kn.get(t)) || n.kn.set(t, u = {}); var f = u[e]; if (r !== f && (u[e] = r, o = n.yn.get(t))) {
    var c = u[C + e];
    if (c)
    ...
    !n.gn && t["s-rn"] && k(n, t, i);
} }, E = function (n, t, e, r) { Object.defineProperty(n, t, { configurable: !0, get: e, set: r }); }, C = "wc-", S = function (n, t, e, r, i, o) { try {
    i = new (o = n.G(t).Mn), function (n, t, e, r, i, o) { n.$n.set(r, e), n.kn.has(e) || n.kn.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], c = t[1]; (function (n, t, e, r, i, o, u, c, a) { if (t.type || t.state) {
        var s = n.kn.get(e);
        t.state || (!t.attr || void 0 !== s[i] && "" !== s[i] || (c = o && o.An) && f(a = c[t.attr]) && (s[i] = j(t.type, a)), e.hasOwnProperty(i) && (void 0 === s[i] && (s[i] = j(t.type, e[i])), "mode" !== i && delete e[i])), r.hasOwnProperty(i) && void 0 === s[i] && (s[i] = r[i]), t.watchCallbacks && (s[C + i] = t.watchCallbacks.slice()), E(r, i, function l(t) { return (t = n.kn.get(n.$n.get(this))) && t[i]; }, function v(e, r) { (r = n.$n.get(this)) && (t.state || t.mutable) && A(n, r, i, e, u); });
    }
    else
    ...
    i = {}, n.mn(e, 7, t, !0);
} return n.yn.set(t, i), i; }, O = function (n, t) { for (var e = 0; e < t.childNodes.length; e++) {
    ...
    for (; o = n.Cn.shift();)
        ...
        catch (n) { } return r = { An: {} }, t.Y && Object.keys(t.Y).forEach(function (o) { (i = t.Y[o].nn) && (r.An[i] = n.Yn(e, i)); }), r; }(n.J, t, e)), n.rt(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { if (!n.it && function (n, t) { for (; t;) {
        if (!n.qn(t))
            return 9 !== n.Tn(t);
        t = n.qn(t);
    } }(n.J, t)) {
        n.hn.set(t, !0), _(n, t), y(n.jn.get(t), !0);
        var e = n.yn.get(t);
        e && e.componentDidUnload && e.componentDidUnload(), n.J.X(t), n.ot.delete(t), n.s && n.s.removeHost(t), [n.wn, n.ut, n.bn].forEach(function (n) { return n.delete(t); });
    } })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (O(n, t) && n.yn.get(t) && !n.hn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
    ...
    } k(m, t, a); }); }, gn: !1, dn: !1, it: !1, at: void 0, wn: new WeakMap, st: new WeakMap, En: new WeakMap, ot: new WeakMap, ft: new WeakMap, et: new WeakMap, $n: new WeakMap, bn: new WeakMap, yn: new WeakMap, hn: new WeakMap, pn: new WeakMap, ut: new WeakMap, lt: new WeakMap, jn: new WeakMap, kn: new WeakMap, vn: new Set, Cn: [] }; return e.isServer = e.isPrerender = !(e.isClient = !0), e.window = r, e.location = r.location, e.document = i, e.resourcesUrl = e.publicPath = o, l.h = n, l.Context = e, l.onReady = function () { return new Promise(function (n) { return m.queue.write(function () { return m.vn.size ? m.Cn.push(n) : n(); }); }); }, m.render = function (n, t) { var e, r, i, o, u, c, a, s = function (i, v, p, y, w, b, m, M, g) { if (M = v.vchildren[p], e || (o = !0, "slot" === M.vtag && (r && t.Fn(y, r + "-s"), M.vchildren ? M.vt = !0 : M.pt = !0)), f(M.vtext))
    M.t = t.Pn(M.vtext);
else if (M.pt)
    M.t = t.Pn("");
else {
    if (b = M.t = h || "svg" === M.vtag ? t.xn("http://www.w3.org/2000/svg", M.vtag) : t.Wn(M.vt ? "slot-fb" : M.vtag), n.tt(b) && n.et.delete(a), h = "svg" === M.vtag || "foreignObject" !== M.vtag && h, d(n, null, M, h), f(r) && b["s-si"] !== r && t.Fn(b, b["s-si"] = r), M.vchildren)
        for (w = 0; w < M.vchildren.length; ++w)
            (m = s(i, M, w, b)) && t.Dn(b, m);
    "svg" === M.vtag && (h = !1);
} return M.t["s-hn"] = c, (M.vt || M.pt) && (M.t["s-sr"] = !0, M.t["s-cr"] = u, M.t["s-sn"] = M.vname || "", (g = i && i.vchildren && i.vchildren[p]) && g.vtag === M.vtag && i.t && l(i.t)), M.t; }, l = function (e, r, i, u) { n.it = !0; var f = t.Hn(e); for (i = f.length - 1; i >= 0; i--)
    ...
    if (null == g)
        ...
        "slot" !== g.vtag && "slot" !== A.vtag || l(t.qn(g.t)), m(g, A), t.Rn(n, g.t, t.Un(j.t)), g = e[++d], A = i[--k];
    else if (y(j, $))
        "slot" !== g.vtag && "slot" !== A.vtag || l(t.qn(j.t)), m(j, $), t.Rn(n, j.t, g.t), j = e[--M], $ = i[++h];
    else {
        for (o = null, u = d; u <= M; ++u)
            if (e[u] && f(e[u].vkey) && e[u].vkey === $.vkey) {
                o = u;
                break;
            }
        f(o) ? ((a = e[o]).vtag !== $.vtag ? c = s(e && e[h], r, o, n) : (m(a, $), e[o] = void 0, c = a.t), $ = i[++h]) : (c = s(e && e[h], r, h, n), $ = i[++h]), c && t.Rn(b(g.t), c, w(g.t));
    } d > M ? v(n, null == i[k + 1] ? null : i[k + 1].t, r, i, h, k) : h > k && p(e, d, M); }(o, u, r, c) : f(c) ? (f(e.vtext) && t.Qn(o, ""), v(o, null, r, c, 0, c.length - 1)) : f(u) && p(u, 0, u.length - 1)), h && "svg" === r.vtag && (h = !1); }, M = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.Hn(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Tn(e)) {
        if (e["s-sr"])
        ...
        M(e);
    } }, g = [], j = function (n, e, r, o, u, f, c, a, s, l) { for (u = 0, f = (e = t.Hn(n)).length; u < f; u++) {
    if ((r = e[u])["s-sr"] && (o = r["s-cr"]))
        for (a = t.Hn(t.qn(o)), s = r["s-sn"], c = a.length - 1; c >= 0; c--)
            (o = a[c])["s-cn"] || o["s-nr"] || o["s-hn"] === r["s-hn"] || ((3 === (l = t.Tn(o)) || 8 === l) && "" === s || 1 === l && null === t.Yn(o, "slot") && "" === s || 1 === l && t.Yn(o, "slot") === s) && (g.some(function (n) { return n.dt === o; }) || (i = !0, o["s-sn"] = s, g.push({ ht: r, dt: o })));
    1 === t.Tn(r) && j(r);
} }; return function (f, s, l, v, p, d, h, y, w, b, k, $) { if (a = f, c = t.In(a), u = a["s-cr"], e = v, r = a["s-sc"], o = i = !1, m(s, l), o) {
    for (j(l.t), h = 0; h < g.length; h++)
        (y = g[h]).dt["s-ol"] || ((w = t.Pn(""))["s-nr"] = y.dt, t.Rn(t.qn(y.dt), y.dt["s-ol"] = w, y.dt));
    for (n.it = !0, h = 0; h < g.length; h++) {
        for (y = g[h], k = t.qn(y.ht), $ = t.Un(y.ht), w = y.dt["s-ol"]; w = t.Bn(w);)
    ...
    n.it = !1;
} return i && M(l.t), g.length = 0, l; }; }(m, v), p["s-ld"] = [], p["s-rn"] = !0, p["s-init"] = function () { m.et.set(p, l.loaded = m.dn = !0), v.Vn(r, "appload", { detail: { namespace: t } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(m, l, r, r["s-apps"], r["s-cr"]), l.initialized = !0, m; }, W = {}, x = !1;
