...
function createProviderConsumer(e, r) {
    ...
    return { Provider: function (_a, r) {
            ...
            throw new Error("Please ensure that your Component " + e.is + " has an attribtue with \"@Element\" decorator. " + "This is required to be able to inject properties."); var o = e.prototype.componentWillLoad; e.prototype.componentWillLoad = function () { if (t = s(this[n], r), o)
...
var DeviceTunnel = createProviderConsumer({
    device: undefined,
    services: undefined,
    deviceInformation: undefined
}, (subscribe, child) => (h("context-consumer", { subscribe: subscribe, renderer: child })));

export { DeviceTunnel as a };
